...
class DataSetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create data_set" do
    assert_difference('DataSet.count') do
      post data_sets_url, params: { data_set: { description: @data_set.description, name: @data_set.name, uid: @data_set.uid, user_id: @data_set.user_id } }
    end
  ...
  test "should update data_set" do
    patch data_set_url(@data_set), params: { data_set: { description: @data_set.description, name: @data_set.name, uid: @data_set.uid, user_id: @data_set.user_id } }
